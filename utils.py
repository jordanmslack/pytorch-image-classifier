...
def transform_image(data_dir):
    ...
    image_datasets = {
        ...
        'test_data': datasets.ImageFolder(f'{data_dir}/valid',
                                          transform=data_transforms['test_transforms']),
        'valid_data': datasets.ImageFolder(f'{data_dir}/test',
                                           transform=data_transforms['validation_transforms'])
    }
...
def train_network(model, trainloader, validloader, device, optimizer, epochs, print_every=10):
...
def arg_parser(type=None):
    ...
    if type == 'test':
        ...
        parser.add_argument('--save_dir', type=str, default='/image_classifier')
        ...
        parser.add_argument('--image', type=str, default='/image_classifier/data/flowers/test/1/image_06743.jpg')
        parser.add_argument('--checkpoint', type=str, default='/image_classifier/checkpoint.pth')
